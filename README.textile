...
<pre>ActsAsEventOwner::EventSpecification.create :description => 'freak out', :start_time => Time.now.utc, :repeat => :yearly, :frequency => 2, :on => [ 5 ], :on_the => :second, :target => [ :th ], :until => Time.parse("12/31/2012")</pre>
